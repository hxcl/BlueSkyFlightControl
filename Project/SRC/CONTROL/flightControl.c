...
/**********************************************************************************************************
*函 数 名: GetAttInnerCtlTarget
*功能说明: 获取姿态内环控制目标
*形    参: 无
*返 回 值: 目标
**********************************************************************************************************/
Vector3f_t GetAttInnerCtlTarget(void) {
    return fc.attInnerTarget;
}

/**********************************************************************************************************
*函 数 名: GetAttOuterCtlTarget
*功能说明: 获取姿态内环控制目标
*形    参: 无
*返 回 值: 目标
**********************************************************************************************************/
Vector3f_t GetAttOuterCtlTarget(void) {
    return fc.attOuterTarget;
}

/**********************************************************************************************************
*函 数 名: GetPosInnerCtlTarget
*功能说明: 获取位置内环控制目标
*形    参: 无
*返 回 值: 目标
**********************************************************************************************************/
Vector3f_t GetPosInnerCtlTarget(void) {
    return fc.posInnerTarget;
}

/**********************************************************************************************************
*函 数 名: GetPosOuterCtlTarget
*功能说明: 获取位置内环控制目标
*形    参: 无
*返 回 值: 目标
**********************************************************************************************************/
Vector3f_t GetPosOuterCtlTarget(void) {
    return fc.posOuterTarget;
}
...
static void PIDReset(void) {
    ...
    PID_SetParam(&fc.pid[YAW_INNER], 8.0, 10.0, 0, 250, 35);
